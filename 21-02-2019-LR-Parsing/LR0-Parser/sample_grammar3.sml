(* This file contains a sample grammar which can be copied to grammar.sml and run. This grammar is an LR(1) grammar.
   The grammar is -
                                T -> S$
                                S -> V = E | E
                                E -> V
...
val initialStateLr0 = ref State.empty;
initialStateLr0 := State.add (!initialStateLr0, { lhs = Atom.atom "T", before = [], after = [Atom.atom "S", Atom.atom "$"] });