...
STRING | MULTILINE_STRING | COMMENT | ESCAPE | INITIAL
...
fun yyAction2 (strm, lastMatch : yymatch) = (yystrm := strm;
      ( YYBEGIN COMMENT; commentCnt := !commentCnt + 1; continue () ))
fun yyAction3 (strm, lastMatch : yymatch) = (yystrm := strm;
      ( commentCnt := !commentCnt - 1; if (!commentCnt) = 0 then YYBEGIN INITIAL else (); continue () ))
...
fun yyAction24 (strm, lastMatch : yymatch) = (yystrm := strm;
      ( Tokens.LBRACES (yypos, yypos + 1) ))
fun yyAction25 (strm, lastMatch : yymatch) = (yystrm := strm;
      ( Tokens.RBRACES (yypos, yypos + 1) ))
fun yyAction26 (strm, lastMatch : yymatch) = (yystrm := strm;
      ( Tokens.LBRACKETS (yypos, yypos + 1) ))
fun yyAction27 (strm, lastMatch : yymatch) = (yystrm := strm;
      ( Tokens.RBRACKETS (yypos, yypos + 1) ))
fun yyAction28 (strm, lastMatch : yymatch) = (yystrm := strm;
      ( Tokens.PLUS (yypos, yypos + 1) ))
fun yyAction29 (strm, lastMatch : yymatch) = (yystrm := strm;
      ( Tokens.MINUS (yypos, yypos + 1) ))
fun yyAction30 (strm, lastMatch : yymatch) = (yystrm := strm;
      ( Tokens.MULTIPLY (yypos, yypos + 1) ))
...
fun yyAction45 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        ( Tokens.INTEGER (valOf (Int.fromString yytext), yypos, yypos + size yytext) )
      end
...
fun yyAction47 (strm, lastMatch : yymatch) = (yystrm := strm;
      ( YYBEGIN STRING; inString := true; stringPos := yypos; str := ""; continue () ))
fun yyAction48 (strm, lastMatch : yymatch) = (yystrm := strm;
      ( YYBEGIN INITIAL; inString := false; Tokens.STRING (!str, !stringPos, yypos + 1) ))
...
fun yyAction52 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        ( YYBEGIN STRING; ErrorMsg.error yypos ("Illegal character '" ^ yytext ^ "' found in multiline string"); continue () )
      end
...
fun yyAction54 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        ( YYBEGIN STRING; str := (!str) ^ "\\" ^ yytext; continue () )
      end
fun yyAction55 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm;
        ( YYBEGIN STRING; str := (!str) ^ String.str (Char.chr (valOf (Int.fromString yytext))); continue () )
      end
fun yyAction56 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm;
        ( YYBEGIN STRING; ErrorMsg.error yypos ("Illegal character '" ^ yytext ^ "' found inside escape sequence"); continue () )
      end
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction46(strm, yyNO_MATCH)
                      else yyQ63(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction46(strm, yyNO_MATCH)
                  else yyQ63(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction21(strm, yyNO_MATCH)
                      else yyQ63(strm', yyMATCH(strm, yyAction21, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction21(strm, yyNO_MATCH)
                  else yyQ63(strm', yyMATCH(strm, yyAction21, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction46(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction46(strm, yyNO_MATCH)
                  else yyQ68(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ63(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
              else yyAction46(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction46(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction46(strm, yyNO_MATCH)
                  else yyQ101(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ63(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
              else yyAction46(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction46(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction46(strm, yyNO_MATCH)
                  else yyQ105(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ63(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
              else yyAction46(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ44 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction36(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ107(strm', yyMATCH(strm, yyAction36, yyNO_MATCH))
...
fun yyQ42 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction34(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              then yyQ109(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
            else if inp < #">"
              then if inp = #"="
       ...
       of NONE => yyAction1(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\n"
              ...
              then if inp = #"\t"
                  then yyQ112(strm', yyMATCH(strm, yyAction1, yyNO_MATCH))
...
in
  (case (!(yyss))
   of STRING => yyQ0(!(yystrm), yyNO_MATCH)
    | MULTILINE_STRING => yyQ1(!(yystrm), yyNO_MATCH)
